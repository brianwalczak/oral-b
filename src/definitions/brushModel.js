...
export class BrushModel {
    ...
    static D21 = Object.freeze({
        name: "D21",
        isiO: false,
        bytes: [127, 64, 65, 66, 69, 67, 68, 70],
    ...
    static fromByte(byte) {
        const brush = BrushModel.values.find(brush => brush.bytes.includes(byte)) ?? null;
        const type = (brush && brush.types) ? brush.types[brush.bytes.indexOf(byte)] : null;
